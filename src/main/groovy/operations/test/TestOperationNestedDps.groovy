...
//        def params = new GDynamicPropertySetSupport()
        ...
        params.add { /*GROUP_ID = "1"; GROUP_NAME = "GROUP NAME 1";*/ name = "prop1"; DISPLAY_NAME = "Property 1"; value = "val1" }
        params.add { /*GROUP_ID = "1"; GROUP_NAME = "GROUP NAME 1";*/ name = "prop2"; DISPLAY_NAME = "Property 2"; value = DateUtils.currentDate() }
        params.add {
